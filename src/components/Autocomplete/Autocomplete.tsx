...
export default function ComboBox() {
  const [selectedFilm, setSelectedFilm] = useState<FilmOptionType | null>(
    () => {
      const storedFilm = localStorage.getItem("selectedFilm");
      return storedFilm ? JSON.parse(storedFilm) : null;
    }
  );
  ...
  return (
    <CustomContainer>
      ...
      <Box paddingBottom={5}>
        <Typography>Movie: {inputValue === "" ? null : inputValue}</Typography>
      </Box>
      <Autocomplete
        value={selectedFilm}
        disablePortal
